...
title 正在下载,请勿关闭此界面!
if %downloads%==1 bitsadmin /transfer "服务端下载中，请不要关闭" /download /priority normal "https://papermc.io/ci/job/Paper-1.16/lastSuccessfulBuild/artifact/paperclip-279.jar" "%downloaddir%" &exit
